...
private void hacerPedido() {
    ...
    while(true) {
        ...
        int resultPanelProducto = JOptionPane.showConfirmDialog(null, panelProducto, "Añadir producto al pedido", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
