...
public class Ruleta {
	...
	public void juego() {
		...
		do {
			System.out.println("Dame el numero (0-36): ");
			jugador = sc.nextInt();
	...
	public static void main(String[] args) {
		 ...
		 * usuario para poder visualizar el resultado:
		 * 
		 * Enhorabuena has Ganado!!!! Lo siento inténtalo de nuevo!!!
		 * 
		 * Ej: La máquina seleccionó : 0 La máquina seleccionó : 0       El usuario
		 * seleccionó: 0 El usuario seleccionó: 36 (2 puntos)
		 */
